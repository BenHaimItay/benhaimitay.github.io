      ...
      <div className="grid grid-cols-1 items-center md:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="flex flex-col items-start justify-center rounded-lg p-3 lg:py-5 lg:px-12 bg-primary-bg h-full">
          ...
          <p className="text-gray-300 text-sm lg:text-base my-4 lg:my-6 text-center">
            a Pragmatic Husband, Data-Oriented Father, Soft-skilled Software
            Developer ( I sometimes surf too )
          </p>
          <li className="text-gray-300 text-sm lg:text-base my-4 lg:my-6 ">
            🌱 I’m currently learning about scaling ML models in production
          </li>
          <li className="text-gray-300 text-sm lg:text-base my-4 lg:my-6 ">
            👯 I’m looking to collaborate on web3 projects, opensource ML
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-green-400">Ben Haim Itay</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-white">company:</span>
                <span className="text-gray-400">{`'`}</span>
                <span className="text-green-400">Superwise</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-white">location:</span>
                <span className="text-gray-400">{`'`}</span>
                <span className="text-green-400">Israel</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              <div>
